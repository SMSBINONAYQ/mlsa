...
from .PreProcessing import pre_processing, printTime
...
def analyze(keyword_uChoice, uStartDate, uEndDate, uLimit, uLang, username):
   ...
   #2nd Check and create best keyword
    ...
    SVM_Model.loadModel('~/home/saad/mlsa/MachineLearning_models/180k_MySVM_model.pkl')
    SVM_Model.loadVectorizer('~/home/saad/mlsa/MachineLearning_models/180k_MySVM_vectorizer.pkl')
