...
class MLmodel:
    ...
    def nb(self):
        nb = MultinomialNB(random_state=42,n_jobs=-1).fit(self.X_train, self.Y_train)
        self.MLmodel = nb
    ...
    def Classifaction_report(self):
        ...
        Classifaction_report= classification_report(Y_label, self.prediction)*100
        print("\n"+50*"="+f"\nHere is the Classifaction_report of our {self.MLname} model: \n {Classifaction_report}")
        return Classifaction_report