...
def remove_stopwords(str):
    ...
    newStopWords=['people','get','one','getting','u','covid','vaccine','vaccines','vaccinated','vaccination','pfizer','virus','oxford','pfizer','moderna','coronavirus','covid19','covidvaccine','biontech', 'moderna', 'johnson & johnson', 'astrazeneca', 'novavax']
